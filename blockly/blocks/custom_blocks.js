...
function getDirectionLabelText(directionID) {
  if (
    directionID === "Motor.DIRECTION_RIGHT" ||
    directionID === "Motor.DIRECTION_LEFT"
  ) {
    return "turn";
  }
...
function createShadowElement(workspace, blockType, input, defaultNumberValue = null) {
...
Blockly.Blocks["block_terminate_program"] = {
  init: function() {
    this.appendDummyInput()
        .appendField(
            new Blockly.FieldImage(CUSTOM_IMAGES.STOP, 15, 15, "*"),
            "STOP_IMAGE"
        )
...
Blockly.Blocks["block_terminate_all"] = {
  init: function() {
    this.appendDummyInput()
        .appendField(
            new Blockly.FieldImage(CUSTOM_IMAGES.STOP_ALL, 15, 15, "*"),
            "STOP_IMAGE"
        )
...
Blockly.Blocks["block_wait"] = {
  init: function() {
    this.appendDummyInput().appendField(
        new Blockly.FieldImage(CUSTOM_IMAGES.WAIT, 15, 15, "*"),
        "WAIT_IMAGE"
    ).appendField("wait");
...
Blockly.Blocks["block_break"] = {
  init: function() {
    this.appendDummyInput()
        .appendField(
            new Blockly.FieldImage(CUSTOM_IMAGES.BREAK, 15, 15, "*"),
            "BREAK_IMAGE"
        )
        .appendField("break");
    this.setInputsInline(false);
...
Blockly.Blocks["block_drive"] = {
  init: function() {
    ...
    var rotationValueInput = this.appendValueInput("ROTATION").setCheck(
        "Number"
    );
  ...
  onchange: function(event) {
    if (event instanceof Blockly.Events.Change) {
      if (event.name === "DIRECTION") {
        ...
        imageField.setValue(
            CUSTOM_IMAGES[event.newValue.replace("Motor.", "")]
        );
...
Blockly.Blocks["block_motor"] = {
  init: function() {
    this.appendDummyInput()
        .appendField(
            new Blockly.FieldImage(CUSTOM_IMAGES.ENGINE, 15, 15, "*"),
            "ENGINE_IMAGE"
        )
...
Blockly.Blocks["spin_motor"] = {
  init: function() {
    this.appendDummyInput()
        .appendField(
            new Blockly.FieldImage(CUSTOM_IMAGES.SPIN, 15, 15, "*"),
            "SPIN_IMAGE"
        )
...
Blockly.Blocks["block_bumper"] = {
  init: function() {
    this.appendDummyInput()
        .appendField(
            new Blockly.FieldImage(CUSTOM_IMAGES.BUMPER, 15, 15, "*"),
            "BUMPER_IMAGE"
        )
        .appendField("read")
        .appendField(new Blockly.FieldTextInput("S1"), "NAME")
...
Blockly.Blocks["block_play_note"] = {
  init: function() {
    this.appendDummyInput()
        .appendField(
            new Blockly.FieldImage(CUSTOM_IMAGES.TUNE, 15, 15, "*"),
            "TUNE_IMAGE"
        )
...
Blockly.Blocks["block_set_multiple_led"] = {
  init: function() {
    this.appendDummyInput().appendField(
        new Blockly.FieldImage(CUSTOM_IMAGES.LIGHTS, 15, 15, "*"),
        "LIGHT_IMAGE"
...
Blockly.Blocks["play_tune"] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(
            new Blockly.FieldDropdown([["boci", "boci"], ["pipi", "pipi"]]),
            "IN_SOUND"
        );
